...
{
    return(
        <section className={`${styles.flexCenter} ${styles.paddingY} flex.col flex-wrap`}>
            ...
            flex-col mb-8 w-full`}>
                <div className='flex-1 flex flex-col justify-start mr-10'>
                    ...
                    <p className={`${styles.paragraph}mt-4 max-w-[310px]`}>
                        A new way to make the payments easy. reliaable and secure.
                    </p>
                </div>
            ...
            md:flex.row flex-col pt-6 border-t-[1px] border-t-[#3f3r45]">
                ...
                leading-[27px] text-white text-center">
